...
from tools import SOAP_formatter,record_speech,format_conversation,reask,router_condition,general,final_format,push_mongo
...
graph.add_conditional_edges(START,router_agent,["record_speech","general","push_mongo"])
graph.add_edge("general",END)
graph.add_edge("push_mongo",END)
