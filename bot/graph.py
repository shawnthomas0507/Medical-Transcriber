...
from tools import SOAP_formatter,record_speech,format_conversation,reask,router_condition,general,final_format,push_mongo,record_intro_speech,exit,call_pharma
from langgraph.checkpoint.memory import MemorySaver
from langchain_core.messages import HumanMessage,AIMessage,SystemMessage
from model import llm
from langgraph.prebuilt import ToolNode,tools_condition

llm_with_tools=llm.bind_tools(tools=[record_speech,general,push_mongo,call_pharma,exit])
...
graph.add_node("call_pharma",call_pharma)
graph.add_edge(START,"record_intro_speech")
graph.add_conditional_edges("record_intro_speech",router_agent,["record_speech","general","push_mongo","exit","call_pharma"])
...
graph.add_edge("call_pharma",END)
